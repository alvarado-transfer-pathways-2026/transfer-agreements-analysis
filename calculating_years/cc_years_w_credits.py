...
if __name__ == "__main__":
    ...
    cc_csv_path = repo_root / "filtered_results" / "Allan_Hancock_College_filtered.csv"
    selected_ucs = ['UCSD', 'UCSB', 'UCSC']
    output_csv_path = Path(__file__).resolve().parent / "semester_breakdown.csv"
    calculating_cc_years(str(cc_csv_path), selected_ucs, str(output_csv_path))
